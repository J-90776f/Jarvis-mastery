...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "wikipedia" in query:
        ...
        elif 'play music from pc' in query or "music" in query:
            ...
            ans_m = " For your information Jyoti Prakash Swain Created me ! I give Lot of Thannks to Him "
            print(ans_m)
            speak(ans_m)
            ...
            hel = "Hello jyoti Sir ! How May i Help you.."
            print(hel)
            speak(hel)
            ...
            continue 
        elif 'exit' in query or 'abort' in query or 'stop' in query or 'Jarvis bye' in query or 'quit' in query :
